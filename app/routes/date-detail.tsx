...
export function meta({ params }: Route.MetaArgs) {
  ...
  return [
    ...
    { name: "description", content: `국민연금공단(NPS) 코스피 주식 ${formattedDate} 일별 동향 대시보드` },
  ];
}
...
export default function DateDetailRoute() {
  ...
  // Derived selectedDate from route params, falling back to latest database date
  const selectedDate = useMemo(() => {
    ...
    return todayDate;
  }, [routeDate, availableDates, todayDate]);
